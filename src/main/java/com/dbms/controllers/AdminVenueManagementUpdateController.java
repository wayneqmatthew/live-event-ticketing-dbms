...
public class AdminVenueManagementUpdateController {
    ...
    private void onSaveClick(ActionEvent event){
        ...
        if (name.isEmpty() || capacityUpdateField.getText().isEmpty() || city.isEmpty() || country.isEmpty()){
            showAlert(Alert.AlertType.ERROR, "Form Error", "Please fill in all required fields.");
            return;
        }

        try{
            capacity = Integer.parseInt(capacityUpdateField.getText());
    ...
    public void initData(Venue venue){
        ...
        nameUpdateField.setText(venue.getName());
        capacityUpdateField.setText(String.valueOf(venue.getCapacity()));
        cityUpdateField.setText(venue.getCity());
        countryUpdateField.setText(venue.getCountry());
        regionUpdateField.setText(venue.getRegion());
    }
}