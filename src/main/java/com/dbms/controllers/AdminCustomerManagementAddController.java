...
public class AdminCustomerManagementAddController {
    @FXML
    ...
    @FXML
    private DatePicker dateAddField;
    ...
    private void onSaveClick(ActionEvent event){
        ...
        LocalDate date = dateAddField.getValue();
    ...
    public void initData(Customer customer){
        ...
        lastNameAddField.setText(customer.getLast_name());
        firstNameAddField.setText(customer.getFirst_name());
        emailAddField.setText(customer.getEmail());
        phoneNumberAddField.setText(customer.getPhone_number());
        dateAddField.setValue(customer.getRegistration_date());
    }
}
